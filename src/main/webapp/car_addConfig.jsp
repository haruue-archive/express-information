...
<%
    ...
    sql = "insert into tb_CarMessage (TradeMark,Brand,Style,CarLoad,UsedTime,DriverName,DriverTime,LicenceNumber,LicenceStyle,TranspotStyle,LinkMan,LinkPhone,Remark,IssueDate,UserName) " +
            "values('" + numbers + "','" + carname + "','" + types + "','" + loads + "','" + usetime + "','" + drivername + "','" + drivertime + "','" + number + "','" + styles + "','" + transtyle + "','" + linkman + "','" +
