...
<table width="169" height="29" border="0" align="center" cellpadding="0" cellspacing="0">
    <%
        try {
            String placardsql = "select ID,Title from tb_Placard order by id desc limit 10";
    ...
    <tr>
        ...
        <td width="147"><a href="#"
                           onClick="window.open('placard_select.jsp?id=<%=rs1.getInt("ID")%>','','width=786,height=430');"><%=rs1.getString("Title")%>
        </a></td>
    </tr>
    <%
            }
