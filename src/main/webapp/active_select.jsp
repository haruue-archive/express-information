...
<table width="785" height="117" border="1" align="center" cellpadding="0" cellspacing="0"
    ...
    %>
    <tr>
        <td width="108" height="32" align="center"><%=code%>
        </td>
        <td width="108" height="32" align="center"><%=rs.getString("Title")%>
        </td>
        <td width="108" height="32" align="center"><%=rs.getString("Author")%>
        </td>
        <td width="209" height="32" align="center"><%=rs.getDate("IssueDate")%>
        </td>
        <td width="245" height="32" align="center">
            <a href="#"
               onClick="window.open('active_show.jsp?id=<%=code%>','','width=790,height=530');">详细</a>
        </td>
    </tr>
    <%
            if (!rs.next())
