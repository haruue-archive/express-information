...
<form method="POST" action="enterprise_addConfig.jsp" name="form1">
    <table width="786" height="345" border="1" align="center" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td width="758" height="45" colspan="4" align="center">
                <p><input type="submit" value="发布" name="B1" onClick="return check()"><input
                        type="reset" value="重写" name="B2"></td>
        </tr>
    </table>
</form>
</body>
