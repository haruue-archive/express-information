...
<table width="785" height="480" border="1" align="center" cellpadding="0" cellspacing="0"
    ...
    <tr>
        ...
        <td width="36%" height="29" align="center"><%=rs.getString("GoodsStyle")%>
        </td>
        <td width="17%" height="29" align="center" valign="middle">货物名称：</td>
        <td width="30%" height="29" align="center"><%=rs.getString("GoodsName")%>
        </td>
    </tr>
    <tr>
        <td width="17%" height="29" align="center">货物数量：</td>
        <td width="36%" height="29" align="center"><%=rs.getString("GoodsNumber")%>
        </td>
        <td width="17%" height="29" align="center" valign="middle">数量单位：</td>
        <td width="30%" height="29" align="center"><%=rs.getString("GoodsUnit")%>
        </td>
    </tr>
    <tr>
        <td width="17%" height="29" align="center">起始省份：</td>
        <td width="36%" height="29" align="center"><%=rs.getString("StartProvince")%>
        </td>
        <td width="17%" height="29" align="center" valign="middle">起始城市：</td>
        <td width="30%" height="29" align="center"><%=rs.getString("StartCity")%>
        </td>
    </tr>
    <tr>
        <td width="17%" height="29" align="center">抵达省份：</td>
        <td width="36%" height="29" align="center"><%=rs.getString("EndProvince")%>
        </td>
        <td width="17%" height="29" align="center" valign="middle">抵达城市：</td>
        <td width="30%" height="29" align="center"><%=rs.getString("EndCity")%>
        </td>
    </tr>
    <tr>
        <td width="17%" height="30" align="center">运输类型：</td>
        <td width="36%" height="30" align="center"><%=rs.getString("Style")%>
        </td>
        <td width="17%" height="30" align="center" valign="middle">运输时间：</td>
        <td width="30%" height="30" align="center"><%=rs.getString("TransportTime")%>
        </td>
    </tr>
    <tr>
        <td width="17%" height="29" align="center">联系电话：</td>
        <td width="36%" height="29" align="center"><%=rs.getString("Phone")%>
        </td>
        <td width="17%" height="29" align="center" valign="middle">联系人：</td>
        <td width="30%" height="29" align="center"><%=rs.getString("Link")%>
        </td>
    </tr>
    <tr>
        <td width="17%" height="31" align="center">发布时间：</td>
        <td width="36%" height="31" align="left" colspan="3"><%=rs.getDate("IssueDate")%>
        </td>
    ...
    <tr>
        ...
        <td width="83%" height="1" align="center" colspan="3">
            <p align="left"><textarea rows="3" name="S1"
                                      cols="76"><%=rs.getString("Remark")%></textarea></td>
    </tr>
    <tr>
        <td width="17%" height="52" align="center">车辆要求：</td>
        <td width="83%" height="52" align="center" colspan="3">
            <p align="left"><textarea rows="3" name="S1"
                                      cols="76"><%=rs.getString("Request")%></textarea></td>
    </tr>
    <tr>
        <%
        ...
        <td width="36%" height="31" align="left" colspan="3"><%=userName%>
        </td>
