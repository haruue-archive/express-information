            ...
            <table width="786" border="0" align="center" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    ...
                    <th width="597" height="31" align="center"><a href="index.jsp"
                                                                  class="a1">本站首页</a>&nbsp;|&nbsp;<a
                            href="active_select.jsp" class="a1">物流动态</a>&nbsp;|&nbsp;<a
                            href="knowledge_select.jsp" class="a1">物流知识</a>&nbsp;|&nbsp;<a
                            href="goods_select.jsp" class="a1">货物信息</a>&nbsp;|&nbsp;<a
...
<table width="100%" height="115" border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td valign="top">
            <table width="787" height="151" border="0" align="center" cellpadding="0"
                   cellspacing="0" background="image/6.jpg">
                <tr>
                    <td>
