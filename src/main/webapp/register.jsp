...
<center>
    ...
    <form method="POST" action="regist_config.jsp" name="form1">
        ...
        <table width="791" height="205" border="0" cellpadding="0" cellspacing="0"
               background="image/23.jpg">
            <tr>
                <td width="46%" align="left" height="27">
            ...
            <tr>
                ...
                <td width="54%"><input name="repassword" type="password" size="20" maxlength="16">
                </td>
            </tr>
            <tr>
                <td width="46%" height="27">
