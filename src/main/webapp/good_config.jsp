<%@ page contentType="text/html; charset=UTF-8" import="java.sql.ResultSet,java.util.Date" %>
...
<%
    ...
    sql = "insert into tb_GoodsMeg (GoodsStyle,GoodsName,GoodsNumber,GoodsUnit,StartProvince,StartCity,EndProvince,EndCity,Style,TransportTime,Phone,Link,IssueDate,Remark,Request,UserName) "+
            " values('" + gclass + "','" +
