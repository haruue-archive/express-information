...
<table width="785" height="117" border="1" align="center" cellpadding="0" cellspacing="0"
    ...
    %>
    <tr>
        <td width="95" height="32" align="center"><%=code%>
        </td>
        <td width="186" height="32" align="center"><%=rs.getString("Title")%>
        </td>
        <td width="204" height="32" align="center"><%=rs.getString("Author")%>
        </td>
        <td width="158" height="32" align="center"><%=rs.getDate("IssueDate")%>
        </td>
