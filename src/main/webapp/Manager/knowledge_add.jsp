    ...
    <table width="785" border="1" align="center" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td width="100%" height="39">
                <div align="center">物流知识</div>
            </td>
        </tr>
        <tr>
            <td width="100%" height="37"> 标题： &nbsp;<input name="Title" type="text" size="37"
                                                           maxlength="50"> 标题内容最多输入50个字.
            </td>
        </tr>
        <tr>
            <td width="100%" height="37"> 类别： &nbsp;<input name="style" type="text" size="37"
                                                           maxlength="100"> 类别内容最多输入100个字.
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td width="100%" height="36"><textarea rows="20" name="content" cols="100"></textarea>
            </td>
        </tr>
        <tr>
