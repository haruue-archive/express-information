...
<table width="785" height="500" border="0" align="center" cellpadding="0" cellspacing="0"
       class="wenbenkuang">
    <tr>
        <td colspan="2" valign="top">
            <table width="100%" border="1" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="100%" height="12" align=center valign=top bgcolor="#ffcc99"> 辅 助 工
                        具
                    </td>
                </tr>
                <tr>
                                ...
                                <td height="162">
                                    <div align="center">
                                        <form name="form10" method="post" action="">
                                            <table width="394" height="84" border="0"
                                ...
                                <td>
                                    <div align="center">
                                        <form name="form2" method="post" action="">
                                            <table width="347" height="84" border="0"
                                                   cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td height="25" colspan="2">
                                                        <div align="center">
                                                            <input type="button" name="Submit2"
                                                                   value="确认" class=go-wenbenkuang
                                                                   onclick="road();">
                                                            <input type="button" name="Submit3"
                                                                   class=go-wenbenkuang value="查看全部"
