        ...
        <table width="46%" height="216" border="1" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td width="100%" height="16">问题答案：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" name="result" size="20" value="<%=rs.getString("Result")%>">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="100%" height="16">
                    <input type="submit" value="修改" name="Submit" onClick="return check()"> 　<input
                        type="reset" value="重置">
