...
<table width="785" height="377" border="1" align="center" cellpadding="0" cellspacing="0"
       bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#333333">
    <tr>
    ...
    <tr>
        ...
        <td width="31%" height="29" align="center"><%=rs.getString("GoodsStyle")%>
        </td>
        <td width="21%" height="29" align="center">货物名称：</td>
        <td width="27%" height="29" align="center"><%=rs.getString("GoodsName")%>
        </td>
    </tr>
    <tr>
        ...
        <td width="27%" height="29" align="center"><%=rs.getString("GoodsUnit")%>
        </td>
    </tr>
    <tr>
        <td width="21%" height="29" align="center">起始省份：</td>
        <td width="31%" height="29" align="center"><%=rs.getString("StartProvince")%>
        </td>
        <td width="21%" height="29" align="center">起始城市：</td>
        <td width="27%" height="29" align="center"><%=rs.getString("StartCity")%>
        </td>
    </tr>
    <tr>
        <td width="21%" height="29" align="center">抵达省份：</td>
        <td width="31%" height="29" align="center"><%=rs.getString("EndProvince")%>
        </td>
        <td width="21%" height="29" align="center">抵达城市：</td>
        <td width="27%" height="29" align="center"><%=rs.getString("EndCity")%>
        </td>
    </tr>
    <tr>
        <td width="21%" height="30" align="center">运输类型：</td>
        <td width="31%" height="30" align="center"><%=rs.getString("Style")%>
        </td>
        <td width="21%" height="30" align="center">运输时间：</td>
        <td width="27%" height="30" align="center"><%=rs.getString("TransportTime")%>
        </td>
    </tr>
    <tr>
        <td width="21%" height="29" align="center">联系电话：</td>
        <td width="31%" height="29" align="center"><%=rs.getString("Phone")%>
        </td>
    ...
    <tr>
        ...
        <td height="31" colspan="3"><%=rs.getDate("IssueDate")%>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td height="31" colspan="3" align="left"><%=userName%>
        </td>
    </tr>
    <tr>
