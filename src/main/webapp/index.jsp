    ...
    <tr>
        ...
        <td width="484" valign="top">
                ...
                <tr>
                    <td valign="top">
                        ...
                        <table width="370" border="0" cellpadding="0" cellspacing="0">
                            <%
                                goodsql = "select ID,GoodsStyle,GoodsName,StartProvince,StartCity,EndProvince,EndCity,Style,UserName from tb_GoodsMeg order by IssueDate desc limit 8";
                                try {
                            ...
                            <tr>
                                ...
                                <td width="334"><a href="goods_xiangxi.jsp?id=<%=gcode%>">
                                    <%=rs1.getString("GoodsStyle")%>
                                    --<%=rs1.getString("GoodsName")%>-
                                    -<%=rs1.getString("StartProvince")%>-
                                    -<%=rs1.getString("StartCity")%>-
                                    -<%=rs1.getString("EndProvince")%>-
                                    -<%=rs1.getString("EndCity")%>
                                </a></td>
                            </tr>
                            <%
                                    }
                            ...
                            <tr>
                                <td width="36" height="25">&nbsp;</td>
                                <td width="334" align="right"><a href="goods_select.jsp">&nbsp;>>>更多信息&nbsp;&nbsp;&nbsp;</a>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table width="370" border="0" cellpadding="0" cellspacing="0" background="image/17.jpg">
                <%
                    sql = "select Code,TradeMark,Brand,Style,CarLoad,TranspotStyle,UserName from tb_CarMessage order by IssueDate desc limit 8";
                    try {
                ...
                <tr>
                    <td width="36" height="25">&nbsp;</td>
                    <td width="334"><a
                            href="car_show.jsp?id=<%=code%>"><%=rs1.getString("TradeMark")%>-
                        -<%=rs1.getString("Brand")%> -
                        -<%=rs1.getString("Style")%>--<%=rs1.getString("CarLoad")%>吨-
                        -<%=rs1.getString("TranspotStyle")%>
                    </td>
                </tr>
                <%
                        }
                ...
                <tr>
                    <td width="36" height="25">&nbsp;</td>
                    <td width="334" align="right"><a href="car_select.jsp">&nbsp;>>>更多信息&nbsp;&nbsp;&nbsp;</a>
                    </td>
                </tr>
            </table>
            <table width="100" border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="370" border="0" cellpadding="0" cellspacing="0" background="image/19.jpg">
                <%
                    sql = "select ID,EnterpriseSort,EnterpriseName,Operation,WorkArea,Address,UserName from tb_Enterprise order by IssueDate desc limit 7";
                    try {
                        rs1 = connection.executeQuery(sql);
                        while (rs1.next()) {
                            code = rs1.getInt("ID");
                ...
                <tr>
                    <td width="36" height="25">&nbsp;</td>
                    <td width="334"><a
                            href="enterprise_show.jsp?id=<%=code%>"><%=rs1.getString("EnterpriseSort")%>
                        - -<%=rs1.getString("EnterpriseName")%>- -<%=rs1.getString("Operation")%>-
                        -<%=rs1.getString("WorkArea")%>
                    </a></td>
                </tr>
                <%
                        }
                ...
                <tr>
                    <td width="36" height="25">&nbsp;</td>
                    <td width="334" align="right"><a href="enterprise_select.jsp">&nbsp;>>>更多信息&nbsp;&nbsp;&nbsp;</a>
                    </td>
                </tr>
            </table>
        </td><!--存放中间的代码-->
