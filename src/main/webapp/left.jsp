        ...
        <td>
            ...
            <form method="POST" action="login_config.jsp" name="form_u">
                <table width="91%" height="87" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="32%" height="30" align="center" valign="bottom">
                            <div align="right">用户名</div>
                        </td>
                        <td width="68%" align="center" valign="bottom"><input name="name"
                                                                              type="text" size="16"
                                                                              maxlength="20"></td>
                    </tr>
                    <tr>
                        ...
                        <td height="20" align="center"><input type="password" name="password"
            ...
            <table width="92%" height="18" border="0" align="center" cellpadding="0"
                   cellspacing="0">
                <tr>
