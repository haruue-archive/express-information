...
<form method="POST" action="goods_changeConfig.jsp" name="form1">
    ...
    <table width="786" border="1" align="center" cellpadding="0" cellspacing="0"
        ...
        <tr>
            ...
            <td width="30%" height="43">
                <p align="center"><input type="text" name="StartCity" size="20"
        ...
        <tr>
            ...
            <td width="30%" height="46">
                <p align="center"><input type="text" name="EndCity" size="20"
        ...
        <tr>
            ...
            <td width="84%" height="78" colspan="3">
                <p align="left"><textarea rows="5" name="gremark"
        ...
        <tr>
            ...
            <td width="84%" height="74" colspan="3">
                <p align="left"><textarea rows="5" name="grequest"
