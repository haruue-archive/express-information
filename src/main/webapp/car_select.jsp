...
<table width="786" height="137" border="1" align="center" cellpadding="0" cellspacing="0"
    ...
    %>
    <tr>
        <td width="11%" height="29" align="center"><%=rs.getString("TradeMark")%>
        </td>
        <td width="11%" height="29" align="center"><%=rs.getString("Brand")%>
        </td>
        <td width="11%" height="29" align="center"><%=rs.getString("Style")%>
        </td>
        ...
        <td width="11%" height="29" align="center"><%=rs.getString("TranspotStyle")%>
        </td>
